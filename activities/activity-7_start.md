...
> Use the vocabulary you have been working with today: **loss**, **gradient**, **generalisation gap**, **convergence**, **learning rate**. If you can explain these concepts to someone who was not in this room today, you have understood them.
...
## 📝 Task 2 — Part E Horizon Scan (individual, 15 minutes)

Your Task 6 upload must include a horizon scan source. Find one now, while the topic is fresh.

**Your task:** Find **one** recent, credible source relevant to what you have done today.

Credible sources include:
- arXiv or a peer-reviewed conference (e.g. NeurIPS, ICLR, ACL)
- Official documentation or release notes (e.g. Hugging Face blog, PyTorch)
...
✅ **Checkpoint:** Part E table completed before the shareback.

---

## 📝 Task 3 — Brief Shareback

Your coach will ask 2–3 volunteers to share:

- What source did you find?
- Why did you choose it?
- What would you do with it in your Task 6 submission?

📘 **Note:** You are not presenting a summary — you are modelling self-directed learning (B1). Two sentences is enough.

---

## 📝 Task 4 — Task 6 Checklist

Before you close your laptop, confirm which Task 6 items you have produced today:

| Item | Source | Done? |
|---|---|---|
| Before/after performance comparison | Baseline + trained metrics (Part B) | ☐ |
...
If you found a source on parameter-efficient fine-tuning (e.g. LoRA or adapter layers):

- How does the approach it describes differ from what you did today (full fine-tuning)?
- What problem is it solving — and under what conditions would you choose it over full fine-tuning?

Write 3–4 sentences. This could go directly into your Task 6 S31/K28 reflection.
